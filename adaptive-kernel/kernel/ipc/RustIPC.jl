...
# Page-aligned memory region for lock-free IPC (Phase 1 spec)
const SHM_BASE_ADDR = 0x01000000  # Page-aligned base address
const SHM_END_ADDR = 0x05000000    # 64MB region

const SHM_SIZE = 0x0400_0000  # 64MB (0x01000000 - 0x05000000)
